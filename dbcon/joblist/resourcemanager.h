...
//passed by ExeMgr and DistributedEngineComm to MessageQueueServer or -Client
    ...
    {
        return  getUintVal(fExeMgrStr, "ServerThreads", defaultEMServerThreads);
    }
    int  	getEmServerQueueSize() const
    {
        return  getUintVal(fExeMgrStr, "ServerQueueSize", defaultEMServerQueueSize);
    }
    ...
    {
        return  getUintVal(fExeMgrStr, "ExecQueueSize", defaultEMExecQueueSize);
    }
    ...
    uint32_t  	getJLThreadPoolSize() const
    {
        return  getUintVal(fJobListStr, "ThreadPoolSize", defaultJLThreadPoolSize);
    }
