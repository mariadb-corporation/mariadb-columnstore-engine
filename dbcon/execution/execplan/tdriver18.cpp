...
order by \
    ...
    SimpleFilter* sf1 = new SimpleFilter(new Operator("IN"), new SimpleColumn("tpch.lineitem.??"),
    ...
    SimpleFilter* sh1 = new SimpleFilter(new Operator(">"), new ArithmeticColumn("sum(l_quantity)"),
    ...
    SelectFilter* f1 =
        new SelectFilter(new SimpleColumn("tpch.orders.o_orderkey"), new Operator("IN"), subcsep);
    ...
    SimpleFilter* f3 = new SimpleFilter(new Operator("="), new SimpleColumn("tpch.orders.o_orderkey"),
