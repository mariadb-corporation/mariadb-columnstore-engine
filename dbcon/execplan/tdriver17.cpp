...
where \
    ...
    SimpleFilter* f3 = new SimpleFilter(new Operator("not like"), new SimpleColumn("tpch.part.p_container"),
    ...
    SimpleFilter* sf1 = new SimpleFilter(new Operator("="), new SimpleColumn("tpch.lineitem.l_suppkey"),
    ...
    SelectFilter* f4 =
        new SelectFilter(new SimpleColumn("tpch.lineitem.l_quantity"), new Operator("<"), subcsep);
