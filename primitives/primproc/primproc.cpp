...
size_t allowedMemSize = 0;        // zero means value is not set. it can be set at any time.
...
extern "C" static void* ppHooksExtentAlloc(extent_hooks_t *extent_hooks, void *new_addr, size_t size,
