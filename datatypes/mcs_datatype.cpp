...
const TypeHandler *
TypeHandler::find(SystemCatalog::ColDataType typeCode,
...
const TypeHandler *
SystemCatalog::TypeHolderStd::typeHandler() const
{
...
boost::any
SystemCatalog::TypeHolderStd::getNullValueForType() const
{
...
const TypeHandler *
TypeHandler::find_by_ddltype(const ddlpackage::ColumnType &ct)
{
  switch (ct.fType) {
...
int TypeHandlerDate::storeValueToField(rowgroup::Row &row, int pos,
                                       StoreField *f) const
{
...
int TypeHandlerDatetime::storeValueToField(rowgroup::Row &row, int pos,
                                           StoreField *f) const
{
...
int TypeHandlerTime::storeValueToField(rowgroup::Row &row, int pos,
                                       StoreField *f) const
{
  int64_t intColVal = row.getUintField<8>(pos);
...
int TypeHandlerTimestamp::storeValueToField(rowgroup::Row &row, int pos,
                                            StoreField *f) const
{
  int64_t intColVal = row.getUintField<8>(pos);
...
int TypeHandlerVarbinary::storeValueToField(rowgroup::Row &row, int pos,
                                            StoreField *f) const
{
  uint32_t l;
...
int TypeHandlerSInt64::storeValueToField(rowgroup::Row &row, int pos,
                                         StoreField *f) const
{
...
int TypeHandlerUInt64::storeValueToField(rowgroup::Row &row, int pos,
                                         StoreField *f) const
{
...
int TypeHandlerInt::storeValueToFieldSInt32(rowgroup::Row &row, int pos,
                                            StoreField *f) const
{
...
int TypeHandlerInt::storeValueToFieldUInt32(rowgroup::Row &row, int pos,
                                            StoreField *f) const
{
...
int TypeHandlerSInt16::storeValueToField(rowgroup::Row &row, int pos,
                                         StoreField *f) const
{
...
int TypeHandlerUInt16::storeValueToField(rowgroup::Row &row, int pos,
                                         StoreField *f) const
{
...
int TypeHandlerSInt8::storeValueToField(rowgroup::Row &row, int pos,
                                        StoreField *f) const
{
...
int TypeHandlerUInt8::storeValueToField(rowgroup::Row &row, int pos,
                                        StoreField *f) const
{
...
*/
int TypeHandlerReal::storeValueToFieldXFloat(rowgroup::Row &row, int pos,
                                             StoreField *f) const
{
...
int TypeHandlerReal::storeValueToFieldXDouble(rowgroup::Row &row, int pos,
                                              StoreField *f) const
{
...
int TypeHandlerSLongDouble::storeValueToField(rowgroup::Row &row, int pos,
                                              StoreField *f) const
{
...
int TypeHandlerStr::storeValueToFieldBlobText(rowgroup::Row &row, int pos,
                                              StoreField *f) const
{
  return f->store_lob((const char*) row.getVarBinaryField(pos),
                      row.getVarBinaryLength(pos));
}
...
string TypeHandlerDate::format(const SimpleValue &v,
...
string TypeHandlerTime::format(const SimpleValue &v,
                               const SystemCatalog::TypeAttributesStd &attr)
                               const
{
...
string TypeHandlerChar::format(const SimpleValue &v,
                               const SystemCatalog::TypeAttributesStd &attr)
                               const
{
...
string
TypeHandlerXDecimal::format64(const SimpleValue &v,
                              const SystemCatalog::TypeAttributesStd &attr)
                              const
{
...
string
TypeHandlerXDecimal::format128(const SimpleValue &v,
                               const SystemCatalog::TypeAttributesStd &attr)
                               const
{
                             ...
                             const MinMaxInfo &pi) const
{
  ...
  if (pi.isEmptyOrNullSInt64())
    ...
    output << setw(30) << format(SimpleValueSInt64(pi.min), attr)
           << setw(30) << format(SimpleValueSInt64(pi.max), attr);
  return output.str();
}


string TypeHandler::formatPartitionInfoUInt64(
                             const SystemCatalog::TypeAttributesStd &attr,
                             const MinMaxInfo &pi) const
{
  ostringstream output;
...
string
TypeHandlerXDecimal::formatPartitionInfo128(
                              const SystemCatalog::TypeAttributesStd &attr,
                              const MinMaxInfo &pi) const
{
  ostringstream output;
...
string
TypeHandlerStr::formatPartitionInfoSmallCharVarchar(
                         const SystemCatalog::TypeAttributesStd &attr,
                         const MinMaxInfo &pi) const
{
  ostringstream output;
...
string
TypeHandlerChar::formatPartitionInfo(const SystemCatalog::TypeAttributesStd &attr,
                                     const MinMaxInfo &pi) const
{
...
string
TypeHandlerVarchar::formatPartitionInfo(const SystemCatalog::TypeAttributesStd &attr,
                                        const MinMaxInfo &pi) const
{
...
TypeHandlerSInt8::newSimpleColumn(const DatabaseQualifiedColumnName &name,
                                  SystemCatalog::TypeHolderStd &ct,
                                  const SimpleColumnParam &prm) const
{
  if (ct.scale == 0)
    return new execplan::SimpleColumn_INT<1>(name.db(), name.table(), name.column(), prm.columnStore(), prm.sessionid());
  ct.colDataType = SystemCatalog::DECIMAL;
  return new execplan::SimpleColumn_Decimal<1>(name.db(), name.table(), name.column(), prm.columnStore(), prm.sessionid());
}


execplan::SimpleColumn *
TypeHandlerSInt16::newSimpleColumn(const DatabaseQualifiedColumnName &name,
                                   SystemCatalog::TypeHolderStd &ct,
                                   const SimpleColumnParam &prm) const
{
  if (ct.scale == 0)
    return new execplan::SimpleColumn_INT<2>(name.db(), name.table(), name.column(), prm.columnStore(), prm.sessionid());
  ct.colDataType = SystemCatalog::DECIMAL;
  return new execplan::SimpleColumn_Decimal<2>(name.db(), name.table(), name.column(), prm.columnStore(), prm.sessionid());
}


execplan::SimpleColumn *
TypeHandlerSInt24::newSimpleColumn(const DatabaseQualifiedColumnName &name,
                                   SystemCatalog::TypeHolderStd &ct,
                                   const SimpleColumnParam &prm) const
{
  if (ct.scale == 0)
    return new execplan::SimpleColumn_INT<4>(name.db(), name.table(), name.column(), prm.columnStore(), prm.sessionid());
  ct.colDataType = SystemCatalog::DECIMAL;
  return new execplan::SimpleColumn_Decimal<4>(name.db(), name.table(), name.column(), prm.columnStore(), prm.sessionid());
}


execplan::SimpleColumn *
TypeHandlerSInt32::newSimpleColumn(const DatabaseQualifiedColumnName &name,
                                   SystemCatalog::TypeHolderStd &ct,
                                   const SimpleColumnParam &prm) const
{
  if (ct.scale == 0)
...
execplan::SimpleColumn *
TypeHandlerSInt64::newSimpleColumn(const DatabaseQualifiedColumnName &name,
                                   SystemCatalog::TypeHolderStd &ct,
                                   const SimpleColumnParam &prm) const
{
  if (ct.scale == 0)
    return new execplan::SimpleColumn_INT<8>(name.db(), name.table(), name.column(), prm.columnStore(), prm.sessionid());
  ct.colDataType = SystemCatalog::DECIMAL;
  return new execplan::SimpleColumn_Decimal<8>(name.db(), name.table(), name.column(), prm.columnStore(), prm.sessionid());
}


execplan::SimpleColumn *
TypeHandlerUInt8::newSimpleColumn(const DatabaseQualifiedColumnName &name,
                                  SystemCatalog::TypeHolderStd &ct,
                                  const SimpleColumnParam &prm) const
{
  // QQ: why scale is not checked (unlike SInt1)?
  return new execplan::SimpleColumn_UINT<1>(name.db(), name.table(), name.column(), prm.columnStore(), prm.sessionid());
}


execplan::SimpleColumn *
TypeHandlerUInt16::newSimpleColumn(const DatabaseQualifiedColumnName &name,
                                   SystemCatalog::TypeHolderStd &ct,
                                   const SimpleColumnParam &prm) const
{
  return new execplan::SimpleColumn_UINT<2>(name.db(), name.table(), name.column(), prm.columnStore(), prm.sessionid());
}


execplan::SimpleColumn *
TypeHandlerUInt24::newSimpleColumn(const DatabaseQualifiedColumnName &name,
                                   SystemCatalog::TypeHolderStd &ct,
                                   const SimpleColumnParam &prm) const
{
  return new execplan::SimpleColumn_UINT<4>(name.db(), name.table(), name.column(), prm.columnStore(), prm.sessionid());
}


execplan::SimpleColumn *
TypeHandlerUInt32::newSimpleColumn(const DatabaseQualifiedColumnName &name,
                                   SystemCatalog::TypeHolderStd &ct,
                                   const SimpleColumnParam &prm) const
{
  return new execplan::SimpleColumn_UINT<4>(name.db(), name.table(), name.column(), prm.columnStore(), prm.sessionid());
...
execplan::SimpleColumn *
TypeHandlerUInt64::newSimpleColumn(const DatabaseQualifiedColumnName &name,
                                   SystemCatalog::TypeHolderStd &ct,
                                   const SimpleColumnParam &prm) const
{
  return new execplan::SimpleColumn_UINT<8>(name.db(), name.table(), name.column(), prm.columnStore(), prm.sessionid());
}


execplan::SimpleColumn *
TypeHandlerReal::newSimpleColumn(const DatabaseQualifiedColumnName &name,
                                 SystemCatalog::TypeHolderStd &ct,
                                 const SimpleColumnParam &prm) const
{
   // QQ
   return new execplan::SimpleColumn(name.db(), name.table(), name.column(),
                                     prm.columnStore(), prm.sessionid());
}


execplan::SimpleColumn *
TypeHandlerXDecimal::newSimpleColumn(const DatabaseQualifiedColumnName &name,
                                     SystemCatalog::TypeHolderStd &ct,
                                     const SimpleColumnParam &prm) const
{
   // QQ
...
execplan::SimpleColumn *
TypeHandlerStr::newSimpleColumn(const DatabaseQualifiedColumnName &name,
                                SystemCatalog::TypeHolderStd &ct,
                                const SimpleColumnParam &prm) const
{
   // QQ
...
execplan::SimpleColumn *
TypeHandlerTemporal::newSimpleColumn(const DatabaseQualifiedColumnName &name,
                                     SystemCatalog::TypeHolderStd &ct,
                                     const SimpleColumnParam &prm) const
{
   // QQ
...
public:
  ...
  int64_t  to_sint64() const { return boost::any_cast<long long>(*this); }
  uint64_t to_uint64() const { return boost::any_cast<uint64_t>(*this); }
  uint32_t to_uint32() const { return boost::any_cast<uint32_t>(*this); }
  int128_t to_sint128() const { return boost::any_cast<int128_t>(*this); }
};
...
SimpleValue
TypeHandlerSInt8::toSimpleValue(const SessionParam &sp,
                                const SystemCatalog::TypeAttributesStd &attr,
...
SimpleValue
TypeHandlerSInt16::toSimpleValue(const SessionParam &sp,
                                 const SystemCatalog::TypeAttributesStd &attr,
                                 const char *str, round_style_t & rf) const
{
...
SimpleValue
TypeHandlerSInt24::toSimpleValue(const SessionParam &sp,
                                 const SystemCatalog::TypeAttributesStd &attr,
                                 const char *str, round_style_t & rf) const
{
...
SimpleValue
TypeHandlerSInt32::toSimpleValue(const SessionParam &sp,
                                 const SystemCatalog::TypeAttributesStd &attr,
                                 const char *str, round_style_t & rf) const
{
...
SimpleValue
TypeHandlerSInt64::toSimpleValue(const SessionParam &sp,
                                 const SystemCatalog::TypeAttributesStd &attr,
                                 const char *str, round_style_t & rf) const
{
...
SimpleValue
TypeHandlerUInt8::toSimpleValue(const SessionParam &sp,
                                const SystemCatalog::TypeAttributesStd &attr,
                                const char *str, round_style_t & rf) const
{
...
SimpleValue
TypeHandlerUInt16::toSimpleValue(const SessionParam &sp,
                                 const SystemCatalog::TypeAttributesStd &attr,
                                 const char *str, round_style_t & rf) const
{
...
SimpleValue
TypeHandlerUInt24::toSimpleValue(const SessionParam &sp,
                                 const SystemCatalog::TypeAttributesStd &attr,
                                 const char *str, round_style_t & rf) const
{
...
SimpleValue
TypeHandlerUInt32::toSimpleValue(const SessionParam &sp,
                                 const SystemCatalog::TypeAttributesStd &attr,
                                 const char *str, round_style_t & rf) const
{
...
SimpleValue
TypeHandlerUInt64::toSimpleValue(const SessionParam &sp,
                                 const SystemCatalog::TypeAttributesStd &attr,
                                 const char *str, round_style_t & rf) const
{
...
SimpleValue
TypeHandlerDate::toSimpleValue(const SessionParam &sp,
                               const SystemCatalog::TypeAttributesStd &attr,
                               const char *str, round_style_t & rf) const
{
  idbassert(attr.colWidth <= SystemCatalog::EIGHT_BYTE);
...
SimpleValue
TypeHandlerDatetime::toSimpleValue(const SessionParam &sp,
                                   const SystemCatalog::TypeAttributesStd &attr,
                                   const char *str, round_style_t & rf) const
{
  idbassert(attr.colWidth <= SystemCatalog::EIGHT_BYTE);
...
SimpleValue
TypeHandlerTimestamp::toSimpleValue(const SessionParam &sp,
                                    const SystemCatalog::TypeAttributesStd &attr,
                                    const char *str, round_style_t & rf) const
{
  idbassert(attr.colWidth <= SystemCatalog::EIGHT_BYTE);
...
SimpleValue
TypeHandlerTime::toSimpleValue(const SessionParam &sp,
                               const SystemCatalog::TypeAttributesStd &attr,
                               const char *str, round_style_t & rf) const
{
  idbassert(attr.colWidth <= SystemCatalog::EIGHT_BYTE);
...
SimpleValue
TypeHandlerXDecimal::toSimpleValue(const SessionParam &sp,
                                   const SystemCatalog::TypeAttributesStd &attr,
                                   const char *str, round_style_t & rf) const
{
...
SimpleValue
TypeHandlerStr::toSimpleValue(const SessionParam &sp,
                              const SystemCatalog::TypeAttributesStd &attr,
                              const char *str, round_style_t & rf) const
{
...
MinMaxPartitionInfo
TypeHandler::getExtentPartitionInfo(const SystemCatalog::TypeAttributesStd &attr,
                                    BRM::DBRM &em,
...
MinMaxPartitionInfo
TypeHandlerXDecimal::getExtentPartitionInfo64(const SystemCatalog::TypeAttributesStd &attr,
                                              BRM::DBRM &em,
                                              const BRM::EMEntry &entry,
                                              int *state) const
{
...
MinMaxPartitionInfo
TypeHandlerXDecimal::getExtentPartitionInfo128(const SystemCatalog::TypeAttributesStd &attr,
                                               BRM::DBRM &em,
                                               const BRM::EMEntry &entry,
                                                int *state) const
{
...
MinMaxPartitionInfo
TypeHandlerChar::getExtentPartitionInfo(const SystemCatalog::TypeAttributesStd &attr,
                                        BRM::DBRM &em,
                                        const BRM::EMEntry &entry,
                                        int *state) const
{
...
MinMaxPartitionInfo
TypeHandlerVarchar::getExtentPartitionInfo(const SystemCatalog::TypeAttributesStd &attr,
                                           BRM::DBRM &em,
                                           const BRM::EMEntry &entry,
                                           int *state) const
{
...
string TypeHandler::PrintPartitionValueSInt64(
                               const SystemCatalog::TypeAttributesStd &attr,
                               ...
                               round_style_t rfMax) const
{
  ...
  if (partInfo.min > partInfo.max)
    ...
    oss << setw(30) << format(SimpleValueSInt64(partInfo.min), attr)
        << setw(30) << format(SimpleValueSInt64(partInfo.max), attr);
  return oss.str();
}


string TypeHandler::PrintPartitionValueUInt64(
                 const SystemCatalog::TypeAttributesStd &attr,
                 const MinMaxPartitionInfo &partInfo,
                 const SimpleValue &startVal,
                 round_style_t rfMin,
...
string TypeHandlerXDecimal::PrintPartitionValue128(
                const SystemCatalog::TypeAttributesStd &attr,
                const MinMaxPartitionInfo &partInfo,
                const SimpleValue &startVal,
                round_style_t rfMin,
...
boost::any
TypeHandlerSInt8::getNullValueForType(const SystemCatalog::TypeAttributesStd &attr) const
{
...
boost::any
TypeHandlerUInt8::getNullValueForType(const SystemCatalog::TypeAttributesStd &attr) const
{
...
boost::any
TypeHandlerSInt16::getNullValueForType(const SystemCatalog::TypeAttributesStd &attr) const
{
...
boost::any
TypeHandlerUInt16::getNullValueForType(const SystemCatalog::TypeAttributesStd &attr) const
{
...
boost::any
TypeHandlerSInt24::getNullValueForType(const SystemCatalog::TypeAttributesStd &attr) const
{
...
boost::any
TypeHandlerSInt32::getNullValueForType(const SystemCatalog::TypeAttributesStd &attr) const
{
  int intvalue = joblist::INTNULL;
  boost::any value = intvalue;
  return value;
...
boost::any
TypeHandlerUInt24::getNullValueForType(const SystemCatalog::TypeAttributesStd &attr) const
{
...
boost::any
TypeHandlerUInt32::getNullValueForType(const SystemCatalog::TypeAttributesStd &attr) const
{
  uint32_t uintvalue = joblist::UINTNULL;
  boost::any value = uintvalue;
  return value;
...
boost::any
TypeHandlerSInt64::getNullValueForType(const SystemCatalog::TypeAttributesStd &attr) const
{
...
boost::any
TypeHandlerUInt64::getNullValueForType(const SystemCatalog::TypeAttributesStd &attr) const
{
...
boost::any
TypeHandlerXDecimal::getNullValueForType(const SystemCatalog::TypeAttributesStd &attr) const
{
...
boost::any
TypeHandlerSFloat::getNullValueForType(const SystemCatalog::TypeAttributesStd &attr) const
{
...
boost::any
TypeHandlerUFloat::getNullValueForType(const SystemCatalog::TypeAttributesStd &attr) const
{
  uint32_t jlfloatnull = joblist::FLOATNULL;
  float* fp = reinterpret_cast<float*>(&jlfloatnull);
  boost::any value = *fp;
...
boost::any
TypeHandlerSDouble::getNullValueForType(const SystemCatalog::TypeAttributesStd &attr) const
{
...
boost::any
TypeHandlerUDouble::getNullValueForType(const SystemCatalog::TypeAttributesStd &attr) const
{
  uint64_t jldoublenull = joblist::DOUBLENULL;
  double* dp = reinterpret_cast<double*>(&jldoublenull);
  boost::any value = *dp;
...
boost::any
TypeHandlerDate::getNullValueForType(const SystemCatalog::TypeAttributesStd &attr) const
{
...
boost::any
TypeHandlerDatetime::getNullValueForType(const SystemCatalog::TypeAttributesStd &attr) const
{
...
boost::any
TypeHandlerTime::getNullValueForType(const SystemCatalog::TypeAttributesStd &attr) const
{
...
boost::any
TypeHandlerTimestamp::getNullValueForType(const SystemCatalog::TypeAttributesStd &attr) const
{
...
boost::any
TypeHandlerChar::getNullValueForType(const SystemCatalog::TypeAttributesStd &attr) const
{
...
boost::any
TypeHandlerStr::getNullValueForTypeVarcharText(const SystemCatalog::TypeAttributesStd &attr) const
{
  switch (attr.colWidth)
  {
    case 1:
...
boost::any
TypeHandlerVarbinary::getNullValueForType(const SystemCatalog::TypeAttributesStd &attr) const
{
  WriteEngine::Token nullToken;
  boost::any value = nullToken;
  return value;
