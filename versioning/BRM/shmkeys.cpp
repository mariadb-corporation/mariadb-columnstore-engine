...
ShmKeys::ShmKeys()
{
  ...
  KEYRANGE_VSS_BASE1 = 0x70000 | (BRM_UID << 20);
  KEYRANGE_VSS_BASE2 = 0x80000 | (BRM_UID << 20);
  KEYRANGE_VSS_BASE3 = 0x90000 | (BRM_UID << 20);
  KEYRANGE_VSS_BASE4 = 0xA0000 | (BRM_UID << 20);
  KEYRANGE_VSS_BASE5 = 0xB0000 | (BRM_UID << 20);
  KEYRANGE_VSS_BASE6 = 0xC0000 | (BRM_UID << 20);
  KEYRANGE_VSS_BASE7 = 0xD0000 | (BRM_UID << 20);
  KEYRANGE_VSS_BASE8 = 0xE0000 | (BRM_UID << 20);
