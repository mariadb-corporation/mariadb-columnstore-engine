...
class FilterDriver : public CppUnit::TestFixture
{
 ...
 private:
  ...
  void ORDERBY_TIME_TEST()
  {
    ...
    orderByTest_nRGs(numRows * 16, limit, maxThreads, woParallel, generateRandValues, noDistinct);
    orderByTest_nRGs(numRows * 16, limit, maxThreads, parallel, generateRandValues, noDistinct);
    orderByTest_nRGs(numRows * 16, limit, maxThreads, woParallel, generateRandValues, hasDistinct);
    orderByTest_nRGs(numRows * 16, limit, maxThreads, parallel, generateRandValues, hasDistinct);
  }
  void QUICK_TEST()
  {
    float f = 1.1;
