...
./columnstore_vm.py --machine-name $target-${box} --box ${box} --maxscale-box rocky_8_aws --target $target --server-product MariaDBEnterprise --num 3 --install-test-package True
