...
./run_mtr.py --machine-name $target-${box} --node-name cs000 --mtr-param mtr-columnstore-multinode-test --target $target --product MariaDBEnterprise --use-packages True --install-packages False --multinode True
