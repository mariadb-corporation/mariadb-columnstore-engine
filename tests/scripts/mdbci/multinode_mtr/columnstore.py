...
CENTOS_GLUSTER_REPOS = {
    '7' : {
        'amd64' : "https://buildlogs.centos.org/centos/7/storage/x86_64/gluster-9",
        'x86_64' : "https://buildlogs.centos.org/centos/7/storage/x86_64/gluster-9",
        'aarch64' : "https://buildlogs.centos.org/centos/7/storage/aarch64/gluster-9",
        'ppc64le' : "https://buildlogs.centos.org/centos/7/storage/ppc64le/gluster-9",
    },
    '8' : {
        'amd64' : "https://buildlogs.centos.org/centos/8-stream/storage/x86_64/gluster-11",
        'x86_64' : "https://buildlogs.centos.org/centos/8-stream/storage/x86_64/gluster-11",
        'aarch64' : "https://buildlogs.centos.org/centos/8-stream/storage/aarch64/gluster-11",
        'ppc64le' : "https://buildlogs.centos.org/centos/8-stream/storage/ppc64le/gluster-11",
    },
    '9': {
        'amd64': "https://buildlogs.centos.org/centos/9-stream/storage/x86_64/gluster-11",
        'x86_64': "https://buildlogs.centos.org/centos/9-stream/storage/x86_64/gluster-11",
        'aarch64': "https://buildlogs.centos.org/centos/9-stream/storage/aarch64/gluster-11",
        'ppc64le': "https://buildlogs.centos.org/centos/9-stream/storage/ppc64le/gluster-11",
    },
}
    ...
    for i in range(0, N):
        ...
        if (csVM[i].platform in ['centos', 'rocky', 'rhel', 'alma'] and csVM[i].platform_version in ['8', '9']) \
            ...
            if csVM[i].platform in ['rhel'] and \
                    ...
                    csVM[i].architecture in ['aarch64']:
