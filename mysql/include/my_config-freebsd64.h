...
/* Define to 1 if you have the declaration of `HAVE_ATOMIC_PTHREAD_T', and to
   0 if you don't. */
#define HAVE_DECL_HAVE_ATOMIC_PTHREAD_T 1

/* Define to 1 if you have the declaration of `HAVE_SOLARIS_ATOMICS', and to 0
   if you don't. */
/* #undef HAVE_DECL_HAVE_SOLARIS_ATOMICS */
...
#define SYSTEM_TYPE "unknown-freebsd8.0"
...
#define VERSION "5.1.39-community"
