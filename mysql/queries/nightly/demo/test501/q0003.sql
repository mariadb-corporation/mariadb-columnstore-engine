...
-- -------------------------------------------------------------------------
-- select count(*) from orders where o_orderdate > '1997-08-01' and o_totalprice < 1365  ;
-- -------------------------------------------------------------------------

-- -------------------------------------------------------------------------

-- select count(*) '~200 Million Items' from lineitem where l_shipdate >  '1997-08-01' and l_suppkey <  2000000;
...
-- q0003.2.d
-- select count(*) '~400 Million Items' from lineitem where l_shipdate >  '1997-08-01' and l_suppkey <  4000000;
select o_orderpriority, max(l_shipdate), avg(o_totalprice), count(*) 
from orders, lineitem 
where o_orderdate > '1997-08-01' and o_totalprice < 1365  
	and o_orderkey = l_orderkey 
...
-- -------------------------------------------------------------------------
-- q0003.3.d
-- select count(*) '~600 Million Items' from lineitem where l_shipdate >  '1997-08-01' and l_suppkey <  6000000;
...
-- -------------------------------------------------------------------------
-- q0003.4.d
-- select count(*) '~800 Million Items' from lineitem where l_shipdate >  '1997-08-01' and l_suppkey <  8000000;
