...
avg(ps_supplycost) from part, partsupp where p_size in (48, 49, 50) and p_retailprice <
...
select p_mfgr, count(*), avg(ps_availqty), avg(p_retailprice),
avg(ps_supplycost) from part, partsupp where p_size in (1, 2, 50) and p_retailprice <
