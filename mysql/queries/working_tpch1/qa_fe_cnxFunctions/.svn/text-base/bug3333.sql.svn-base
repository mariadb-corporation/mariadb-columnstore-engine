...
create table if not exists datetest (rowid int, c1 varchar(20), c2 bigint) engine=infinidb;
...
drop table if exists datetest;
select 'q18', year(lo_orderdate), month(lo_orderdate), count(*) from ssb.lineorder group by 1, 2, 3 order by 1, 2, 3;
