select cidx, CBIGINT, SEC_TO_TIME(CBIGINT) from datatypetestm;
select cidx, CDECIMAL1, SEC_TO_TIME(CDECIMAL1) from datatypetestm;
select cidx, CDECIMAL4, SEC_TO_TIME(CDECIMAL4) from datatypetestm;
select cidx, CDECIMAL4_2, SEC_TO_TIME(CDECIMAL4_2) from datatypetestm;
select cidx, CDECIMAL5, SEC_TO_TIME(CDECIMAL5) from datatypetestm;
select cidx, CDECIMAL9, SEC_TO_TIME(CDECIMAL9) from datatypetestm;
select cidx, CDECIMAL9_2, SEC_TO_TIME(CDECIMAL9_2) from datatypetestm;
select cidx, CDECIMAL10, SEC_TO_TIME(CDECIMAL10) from datatypetestm;
select cidx, CDECIMAL18, SEC_TO_TIME(CDECIMAL18) from datatypetestm;
select cidx, CDECIMAL18_2, SEC_TO_TIME(CDECIMAL18_2) from datatypetestm;
select cidx, CINTEGER, SEC_TO_TIME(CINTEGER) from datatypetestm;
select cidx, CSMALLINT, SEC_TO_TIME(CSMALLINT) from datatypetestm;
select cidx, CTINYINT, SEC_TO_TIME(CTINYINT) from datatypetestm;
select cidx, SEC_TO_TIME(0) from datatypetestm;
select cidx, SEC_TO_TIME(3559) from datatypetestm;
select cidx, SEC_TO_TIME(3600) from datatypetestm;
