...
namespace querytele
{
int _kQTTypeValues[] = {QTType::QT_INVALID, QTType::QT_SUMMARY, QTType::QT_PROGRESS, QTType::QT_START};
const char* _kQTTypeNames[] = {"QT_INVALID", "QT_SUMMARY", "QT_PROGRESS", "QT_START"};
const std::map<int, const char*> _QTType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(4, _kQTTypeValues,
                                                                                         _kQTTypeNames),
                                                         ::apache::thrift::TEnumIterator(-1, NULL, NULL));

int _kSTTypeValues[] = {STType::ST_INVALID, STType::ST_SUMMARY, STType::ST_PROGRESS, STType::ST_START};
const char* _kSTTypeNames[] = {"ST_INVALID", "ST_SUMMARY", "ST_PROGRESS", "ST_START"};
const std::map<int, const char*> _STType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(4, _kSTTypeValues,
                                                                                         _kSTTypeNames),
                                                         ::apache::thrift::TEnumIterator(-1, NULL, NULL));

int _kStepTypeValues[] = {StepType::T_INVALID, StepType::T_HJS, StepType::T_DSS, StepType::T_CES,
                          StepType::T_SQS,     StepType::T_TAS, StepType::T_TNS, StepType::T_BPS,
                          StepType::T_TCS,     StepType::T_HVS, StepType::T_WFS, StepType::T_SAS,
                          StepType::T_TUN};
const char* _kStepTypeNames[] = {"T_INVALID", "T_HJS", "T_DSS", "T_CES", "T_SQS", "T_TAS", "T_TNS",
                                 "T_BPS",     "T_TCS", "T_HVS", "T_WFS", "T_SAS", "T_TUN"};
const std::map<int, const char*> _StepType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(13,
                                                                                           _kStepTypeValues,
                                                                                           _kStepTypeNames),
                                                           ::apache::thrift::TEnumIterator(-1, NULL, NULL));

int _kITTypeValues[] = {ITType::IT_INVALID, ITType::IT_SUMMARY, ITType::IT_PROGRESS, ITType::IT_START,
                        ITType::IT_TERM};
const char* _kITTypeNames[] = {"IT_INVALID", "IT_SUMMARY", "IT_PROGRESS", "IT_START", "IT_TERM"};
const std::map<int, const char*> _ITType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(5, _kITTypeValues,
                                                                                         _kITTypeNames),
                                                         ::apache::thrift::TEnumIterator(-1, NULL, NULL));

const char* QueryTele::ascii_fingerprint = "E179941E2BE9C920811D86261E5AAE67";
const uint8_t QueryTele::binary_fingerprint[16] = {0xE1, 0x79, 0x94, 0x1E, 0x2B, 0xE9, 0xC9, 0x20,
                                                   0x81, 0x1D, 0x86, 0x26, 0x1E, 0x5A, 0xAE, 0x67};
...
const uint8_t StepTele::binary_fingerprint[16] = {0x4E, 0x40, 0xC1, 0x7A, 0xE9, 0x2D, 0xFF, 0x83,
                                                  0x3A, 0x8C, 0xC2, 0x33, 0x18, 0xF4, 0xFE, 0x68};
...
const uint8_t ImportTele::binary_fingerprint[16] = {0x9C, 0x47, 0x64, 0x2F, 0x47, 0xF2, 0xAF, 0xBE,
                                                    0xA9, 0x82, 0x38, 0x93, 0x4E, 0xB1, 0xA2, 0x11};
  ...
  if (this->__isset.table_list)
  {
    xfer += oprot->writeFieldBegin("table_list", ::apache::thrift::protocol::T_LIST, 6);
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRING,
                                    static_cast<uint32_t>(this->table_list.size()));
  ...
  if (this->__isset.rows_so_far)
  {
    xfer += oprot->writeFieldBegin("rows_so_far", ::apache::thrift::protocol::T_LIST, 7);
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_I64,
                                    static_cast<uint32_t>(this->rows_so_far.size()));
