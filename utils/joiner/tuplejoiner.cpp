...
template<typename T>
std::unique_ptr<T> makeHashMap(size_t bucketCount, ResourceManager* resourceManager)
{
  ...
  return std::unique_ptr<T>(new T(bucketCount, TupleJoiner::hasher(), typename T::key_equal()));
}
