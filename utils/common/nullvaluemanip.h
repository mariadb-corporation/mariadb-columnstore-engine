...
inline uint64_t getNullValue(execplan::CalpontSystemCatalog::ColDataType t, uint32_t colWidth = 0) {
	  ...
	  switch (t)
    {
        ...
        case CalpontSystemCatalog::STRINT:
        {
            switch (colWidth)
            {
                ...
                default:
                    throw std::logic_error("getNullValue() Can't return the NULL string");
            }
        ...
        default:
            ...
            os << "getNullValue(): got bad column type (" << t <<
               ").  Width=" << colWidth << std::endl;
            throw std::logic_error(os.str());
    }

}
inline int64_t getSignedNullValue(execplan::CalpontSystemCatalog::ColDataType t, uint32_t colWidth = 0) {
    using namespace execplan;
	  switch (t)
    {
        case CalpontSystemCatalog::TINYINT:
        ...
        case CalpontSystemCatalog::STRINT:
        {
            switch (colWidth)
            {
                ...
                default:
                    throw std::logic_error("getSignedNullValue() Can't return the NULL string");
            }
