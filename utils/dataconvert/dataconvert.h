...
inline
int64_t TimeStamp::convertToMySQLint(long timeZone) const
{
...
public:
    ...
    static inline void timestampToString( long long timestampvalue, char* buf, unsigned int buflen, long timezone, long decimals = 0 );
    ...
    static inline void timestampToString1( long long timestampvalue, char* buf, unsigned int buflen, long timezone );
...
inline void DataConvert::timestampToString( long long timestampvalue, char* buf, unsigned int buflen, long timezone, long decimals )
{
    // 10 is default which means we don't need microseconds
    if (decimals > 6 || decimals < 0)
    {
...
inline void DataConvert::timestampToString1( long long timestampvalue, char* buf, unsigned int buflen, long timezone )
{
    TimeStamp timestamp(timestampvalue);
    int64_t seconds = timestamp.second;
