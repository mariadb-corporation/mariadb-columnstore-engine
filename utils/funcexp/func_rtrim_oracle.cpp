...
namespace funcexp
{
CalpontSystemCatalog::ColType Func_rtrim_oracle::operationType(FunctionParm& fp,
...
std::string Func_rtrim_oracle::getStrVal(rowgroup::Row& row, FunctionParm& fp, bool& isNull,
