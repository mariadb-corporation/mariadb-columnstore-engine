...
namespace funcexp
{
CalpontSystemCatalog::ColType Func_trim_oracle::operationType(FunctionParm& fp,
...
std::string Func_trim_oracle::getStrVal(rowgroup::Row& row, FunctionParm& fp, bool& isNull,
