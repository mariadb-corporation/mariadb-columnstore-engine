...
namespace funcexp
{
CalpontSystemCatalog::ColType Func_week::operationType(FunctionParm& fp,
                                                       CalpontSystemCatalog::ColType& resultType)
{
  return resultType;
}

int64_t Func_week::getIntVal(rowgroup::Row& row, FunctionParm& parm, bool& isNull,
                             CalpontSystemCatalog::ColType& op_ct)
{
  ...
  int week = helpers::calc_mysql_week(year, month, day, helpers::convert_mysql_mode_to_modeflags(mode));
