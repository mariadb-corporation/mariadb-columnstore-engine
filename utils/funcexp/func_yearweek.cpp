...
namespace funcexp
{
CalpontSystemCatalog::ColType Func_yearweek::operationType(FunctionParm& fp,
                                                           CalpontSystemCatalog::ColType& resultType)
{
  return resultType;
}

int64_t Func_yearweek::getIntVal(rowgroup::Row& row, FunctionParm& parm, bool& isNull,
                                 CalpontSystemCatalog::ColType& op_ct)
{
  ...
  uint32_t lyear = 0;
  int week = helpers::calc_mysql_week(
      year, month, day, (helpers::convert_mysql_mode_to_modeflags(mode) | helpers::WEEK_NO_ZERO), &lyear);
