...
void Row::compileIsNull(llvm::IRBuilder<>& b, llvm::Value* dataValue, llvm::Value* isNull, uint32_t colIndex)
{
  ...
  switch (types[colIndex])
  {
    case CalpontSystemCatalog::TINYINT:
      b.CreateStore(b.CreateOr(b.CreateICmpEQ(compileIntField<1>(b, dataValue, colIndex, false),
                                              b.getInt8(joblist::TINYINTNULL)),
                               isNullVal),
                    isNull);
      break;
    case CalpontSystemCatalog::SMALLINT:
      b.CreateStore(b.CreateOr(b.CreateICmpEQ(compileIntField<2>(b, dataValue, colIndex, false),
    ...
    case CalpontSystemCatalog::MEDINT:
    case CalpontSystemCatalog::INT:
      b.CreateStore(b.CreateOr(b.CreateICmpEQ(compileIntField<4>(b, dataValue, colIndex, false),
    ...
    case CalpontSystemCatalog::DATE:
      ...
      break;
    case CalpontSystemCatalog::BIGINT:
      b.CreateStore(b.CreateOr(b.CreateICmpEQ(compileIntField<8>(b, dataValue, colIndex, false),
    ...
    case CalpontSystemCatalog::DOUBLE:
      b.CreateStore(b.CreateOr(b.CreateICmpEQ(compileIntField<8>(b, dataValue, colIndex, false),
                    ...
                    isNull);
    case CalpontSystemCatalog::UDOUBLE:
      b.CreateStore(b.CreateOr(b.CreateICmpEQ(compileUintField<8>(b, dataValue, colIndex, false),
                                              b.getInt64(joblist::DOUBLENULL)),
                               isNullVal),
                    isNull);
      break;
    ...
    case CalpontSystemCatalog::UTINYINT:
      b.CreateStore(b.CreateOr(b.CreateICmpEQ(compileUintField<1>(b, dataValue, colIndex, false),
                                              b.getInt8(joblist::UTINYINTNULL)),
                               isNullVal),
                    isNull);
      break;
    case CalpontSystemCatalog::USMALLINT:
      b.CreateStore(b.CreateOr(b.CreateICmpEQ(compileUintField<2>(b, dataValue, colIndex, false),
    ...
    case CalpontSystemCatalog::UINT:
      b.CreateStore(b.CreateOr(b.CreateICmpEQ(compileUintField<4>(b, dataValue, colIndex, false),
