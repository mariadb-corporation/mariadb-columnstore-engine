...
[
  ...
  //  Pipeline("develop-1.4", "centos:8", 'cron'),
  //  Pipeline("develop-1.4", "debian:9", 'cron'),
  //  Pipeline("develop-1.4", "debian:10", 'cron'),
  //  Pipeline("develop-1.4", "ubuntu:16.04", 'cron'),
  //  Pipeline("develop-1.4", "ubuntu:18.04", 'cron'),
  //  Pipeline("develop-1.4", "ubuntu:20.04", 'cron'),
  //  Pipeline("develop-1.4", "opensuse/leap:15", 'cron'),

  Pipeline('develop', 'centos:7', 'cron'),
  //  Pipeline("develop", "centos:8", 'cron'),
  //  Pipeline("develop", "debian:9", 'cron'),
  //  Pipeline("develop", "debian:10", 'cron'),
  //  Pipeline("develop", "ubuntu:16.04", 'cron'),
  //  Pipeline("develop", "ubuntu:18.04", 'cron'),
  //  Pipeline("develop", "ubuntu:20.04", 'cron'),
  //  Pipeline("develop", "opensuse/leap:15", 'cron'),
]
