...
local clang_packages = "clang-%(clang_version)d libclang-common-%(clang_version)d-dev llvm-%(clang_version)d llvm-%(clang_version)d-dev llvm-%(clang_version)d-runtime" % {"clang_version" : 14};
