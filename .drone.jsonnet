  ...
  "steps": [
    ...
    },
    {
      ...
      "commands": [
        ...
        "wget https://cspkg.s3.amazonaws.com/develop-1.4/61/centos7/MariaDB-10.4.12-6-centos7-x86_64-common.rpm -P /drone/src/result",
        "wget https://cspkg.s3.amazonaws.com/develop-1.4/61/centos7/MariaDB-10.4.12-6-centos7-x86_64-gssapi-server.rpm -P /drone/src/result",
        "wget https://cspkg.s3.amazonaws.com/develop-1.4/61/centos7/MariaDB-10.4.12-6-centos7-x86_64-columnstore-libs.rpm -P /drone/src/result",
        "wget https://cspkg.s3.amazonaws.com/develop-1.4/61/centos7/MariaDB-10.4.12-6-centos7-x86_64-columnstore-platform.rpm -P /drone/src/result",
        "wget https://cspkg.s3.amazonaws.com/develop-1.4/61/centos7/MariaDB-10.4.12-6-centos7-x86_64-server.rpm -P /drone/src/result",
