...
local Pipeline(branch, platform, event, arch='amd64', server='10.6-enterprise') = {
  ...
  mtr:: {
    ...
    commands: [
      ...
      'docker exec -t mtr$${DRONE_BUILD_NUMBER} bash -c "/usr/bin/mcsSetConfig SystemConfig CGroup ."',
  ...
  regression:: {
    ...
    commands: [
      ...
      'docker exec -t regression$${DRONE_BUILD_NUMBER} bash -c "/usr/bin/mcsSetConfig SystemConfig CGroup ."',
