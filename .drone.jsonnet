...
local gcc10_update_alternatives = 'update-alternatives --install /usr/bin/gcc gcc /usr/bin/gcc-10 100 --slave /usr/bin/g++ g++ /usr/bin/g++-10 --slave /usr/bin/gcov gcov /usr/bin/gcov-10 ';
...
local ubuntu20_04_deps = 'apt update --yes && apt install -y g++-10 git && ' + gcc10_update_alternatives;
