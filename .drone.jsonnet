...
local platformMap(platform, arch) =
  ...
  local platform_map = {
    ...
    'ubuntu:22.04': ubuntu2202deps + ' && ' + deb_build_deps + " && sleep $${BUILD_DELAY_SECONDS:-1s} && CMAKEFLAGS='" + cmakeflags + " -DDEB=jammy' debian/autobake-deb.sh",
  };
