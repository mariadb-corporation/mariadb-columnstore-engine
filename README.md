#MariaDB ColumnStore Storage/Execution engine 1.0.12
MariaDB ColumnStore 1.0.12 is the development version of MariaDB ColumnStore. 
It is built by porting InfiniDB 4.6.7 on MariaDB 10.1.26 and adding entirely 
new features not found anywhere else.

#MariaDB ColumnStore 1.0.12 is an GA release. 
